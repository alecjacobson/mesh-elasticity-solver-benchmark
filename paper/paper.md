...
_Derived from `paper/references.bib` (auto-generated from `claims/claims.yaml`) and `paper/references_classical.bib` (hand-curated classical ancestors). Citekey = claims-graph node id; formal `\cite` wiring is in the LaTeX render. 69 works._
...
**[akvf]** Claici, Sebastian, Bessmeltsev, Mikhail, Schaefer, Scott, Solomon, Justin. *Isometry-Aware Preconditioning for Mesh Parameterization*. Proc. Symposium on Geometry Processing (SGP) (2017).  
...
**[clamp-filtering]** Teran, Joseph, Sifakis, Eftychios, Irving, Geoffrey, Fedkiw, Ronald. *Robust quasistatic finite elements and flesh simulation*. Proc. Symposium on Computer Animation (SCA) (2005).  
...
**[gill-murray-1974]** Gill, Philip E., Murray, Walter. *Newton-type methods for unconstrained and linearly constrained optimization*. Mathematical Programming (1974).  
...
**[local-global]** Liu, Ligang, Zhang, Lei, Xu, Yin, Gotsman, Craig, Gortler, Steven J.. *A Local/Global Approach to Mesh Parameterization*. Proc. Symposium on Geometry Processing (SGP) (2008).  
**[martin-multiscale]** Martin, Weinkauf, Seidel. *Efficient Non-linear Optimization via Multi-scale Gradient Filtering*. CGF (2013). doi:10.1111/cgf.12019  
...
**[simo-1985-fbar]** Simo, Juan C., Taylor, Robert L., Pister, Karl S.. *Variational and projection methods for the volume constraint in finite deformation elasto-plasticity*. Computer Methods in Applied Mechanics and Engineering (1985).  
...
**[sobolev-lbfgs]** (component of BCQN. *Sobolev-preconditioned L-BFGS (isolated BCQN proxy component)*.  (2018).  
**[splitting-flip-free]** Stein, Li, Solomon. *A Splitting Scheme for Flip-Free Distortion Energies*. SIIMS (2021). doi:10.1137/21M1433058  
