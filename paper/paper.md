...
Of the 160 extracted superiority edges, only **2 are independently validated** and **33 qualified**
...
word (`self-claimed`), 22 are unmeasured (contact), 33 are qualified, and only 2 are independently
