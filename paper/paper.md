...
Of the 160 extracted superiority edges, only **2 are independently validated** and **49 qualified**
...
*Figure 6.1. The epistemic scoreboard. Of 160 extracted superiority edges, 87 are the papers' own
word (`self-claimed`), 22 are unmeasured (contact), 49 are qualified, and only 2 are independently
...
superiority-claims graph stands at **2 validated, 49 qualified, 87 self-claimed, and 22 unmeasured**
edges (`claims/hardening.md`). The verification work promoted twenty-six edges from self-claimed to
qualified — ten from the contact-free triage backlog and sixteen more from a "try-harder" pass that
