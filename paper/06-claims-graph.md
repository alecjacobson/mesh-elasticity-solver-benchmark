...
*Figure 6.1. The epistemic scoreboard. Of 160 extracted superiority edges, 100 are the papers' own
word (`self-claimed`), 22 are unmeasured (contact), 32 are qualified, and only 6 are independently
