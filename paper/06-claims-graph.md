...
*Figure 6.1. The epistemic scoreboard. Of 160 extracted superiority edges, 86 are the papers' own
word (`self-claimed`), 22 are unmeasured (contact), 50 are qualified, and only 2 are independently
