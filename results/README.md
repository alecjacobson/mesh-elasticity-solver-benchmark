...
| P2sMS | multi-seed hardening of the headline (removes the 'single seed' caveat) | [`p2_stable_multiseed.md`](p2_stable_multiseed.md) | with a per-seed perturbed stretch, **absolute beats clamp on all 5/5 seeds** at ν=0.499 (22 vs 30) and ν=0.4999 (39 vs 60), gap **widening** toward the limit — the headline is seed-robust, not a single-seed artifact; still 2D, single-τ, locking-*relieved* element |
